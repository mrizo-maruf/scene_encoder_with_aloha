...
class AlohaTask(BaseTask):
    def __init__(self, 
        ...
        add_scene_3d_model=False
    ) -> None:
        self.num_envs = n_envs
        self.env_spacing = 1.5
        self.add_camera = add_camera
        self.add_scene_3d_model = add_scene_3d_model
    ...
    def set_up_scene(self, scene: Scene) -> None:
        ...
        for scene_id in range(self.num_envs):
            ...
            if self.add_scene_3d_model:
                create_prim(
                    prim_path=f"{scene_prim_path}/scene_3d_model",
                    translation=(0, 0.22, 0),
                    usd_path=get_asset_path("SCENE_ASSET_PATH"),
                )
