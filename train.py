...
env = gymnasium.make("tasks:AlphaBaseEnv-v0", config=config)

checkpoint_callback = CheckpointCallback(save_freq=5000, save_path=log_dir, name_prefix="last_chance8")
